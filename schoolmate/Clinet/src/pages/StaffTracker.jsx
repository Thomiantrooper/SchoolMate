...
export default function AdminStaff() {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <h1 className="text-2xl font-bold">🎓 Admin Staff Panel</h1>
        </div>
      ...
      >
        ...
        {isLoading ? (
          <div className="text-center py-4">Loading staffs...</div>
                  ...
                  <tr key={student._id} className="border-t">
                    ...
                    <td className="p-2">
                      <div className="flex space-x-2">
                        ...
                        <Button size="xs" color="green" onClick={() => openProfileModal(student)} disabled={isLoading}>
                          View Profile
                        </Button>
                      </div>
                    </td>
      ...
      >
        <Modal.Header>{isEditModalOpen ? "Edit Staff" : "Add New Student"}</Modal.Header>
        <Modal.Body>
        ...
        <Modal.Footer>
          <Button onClick={isEditModalOpen ? handleEditStudent : handleAddStudent} disabled={isLoading}>
            {isLoading ? "Processing..." : isEditModalOpen ? "Update" : "Add"} Staff
          </Button>
      ...
      >
        <Modal.Header>Staff Profile</Modal.Header>
        <Modal.Body>
          {profileStudent && (
            <div className={`space-y-4 ${darkMode ? 'text-gray-900' : ''}`}>
              <div className="flex justify-center mb-4">
                <div className={`w-24 h-24 rounded-full flex items-center justify-center text-4xl font-bold 
                  ${profileStudent.gender === 'Female' ? 'bg-pink-100 text-pink-600' : 'bg-blue-100 text-blue-600'}`}>
              ...
              <div className="grid grid-cols-2 gap-4">
                {/* <div>
                  ...
                  <p>{profileStudent.age}</p>
                </div> */}
                <div>
                  <Label className="font-bold">Grade & Section</Label>
                  <p>{profileStudent.grade}-{profileStudent.section}</p>
                </div>
              </div>
              
              <div>
                <Label className="font-bold">Personal Email</Label>
                <p>{profileStudent.personalEmail}</p>
              </div>
              
              {/* <div>
                <Label className="font-bold">School Email</Label>
                <p>{profileStudent.studentEmail}</p>
              </div> */}
            </div>
          )}
        </Modal.Body>
