  ...
  return (
    <Navbar className="border-b-2 shadow-md px-4 py-2 bg-white dark:bg-gray-900 transition-all duration-300">
      ...
      <div className="flex gap-4 md:order-2 items-center">
        ...
        {currentUser ? (
          <Dropdown arrowIcon={false} inline label={<Avatar alt="user" img={profileImage} rounded className="cursor-pointer" />}>
            ...
            <Dropdown.Item onClick={() => navigate('/student-page/student-profile')} className="hover:bg-gray-100 dark:hover:bg-gray-700">
              Profile
            </Dropdown.Item>
            <Dropdown.Divider />
      ...
      <Navbar.Collapse className="space-x-4">
        <Navbar.Link active={path === "/student-page"} as={"div"}>
          <Link to="/student-page" className="text-gray-600 dark:text-gray-300 hover:text-blue-500 transition-all duration-200">
            Home
          </Link>
        </Navbar.Link>
        <Navbar.Link active={path === "/student-page/student-portal"} as={"div"}>
          <Link to="/student-page/student-portal" className="text-gray-600 dark:text-gray-300 hover:text-blue-500 transition-all duration-200">
            Student-portal
          </Link>
        </Navbar.Link>
      </Navbar.Collapse>
